...
>
> ⚠️ **净覆盖率口径统一（✅ 定版 326）**：本文分母 **still_missing 628**（@11:48 快照）为**【历史口径】**。**当前权威 = `out/coverage.json` `summary`：326 success / 673 miss / 999 = 32.63%**（generated_ts 2026-07-03 12:50:24，allow_override=10）。A5 可救前缀分布 / Top10 占比结构仍有效，唯 still_missing 总数以 673 为准。唯一权威见 **《基线口径冻结说明-388-173.md》**。
