...
> 权威口径〔**已更新·173 冻结**〕：**【历史快照】当前权威见 `out/coverage.json`：326 success / 673 miss / 999 = 32.63%**（generated_ts 2026-07-03 12:50:24, allow_override=10）。〔本文成文时写的「净覆盖 371/999 ≈ 37.1%、still_missing ≈ 630」为**【历史口径】**，已被 388/611 取代；亦勿用 448/551 更旧值。〕唯一权威 + 历史对照表见 **《基线口径冻结说明-388-173.md》**。
